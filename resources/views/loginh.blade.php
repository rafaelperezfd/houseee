...
<body>
 ...
 <main class="flex flex-col md:flex-row bg-black min-h-screen">
  ...
  <div class="w-1/2 h-screen md:block hidden bg-cover bg-center" style="background-image: url('{{ asset('image/login.png') }}');"></div>
